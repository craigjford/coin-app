...
# Transaction.create(user_id: u4.id, dealer_id: d2.id, num_ounces: 6, price_per_ounce: 1112)
# Transaction.create(user_id: u4.id, dealer_id: d3.id, num_ounces: 6, price_per_ounce: 1114)
